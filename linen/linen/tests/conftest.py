...
from linen.server.models import Fact, Hint, Intent, ProjectDetail, ProjectMeta
...
class FakeClient:
    ...
    def release_reason(self, project_id: str, worker: str, _lease_id: str) -> ApiResult:
    ...
    def reason_heartbeat(self, _project_id: str, _worker: str, _lease_id: str) -> ApiResult:
        return ApiResult(200, {})
